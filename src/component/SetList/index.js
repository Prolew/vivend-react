    ...
    return (
        <div>
                ...
                <List dense sx={{ width: '100%', maxWidth: 360, bgcolor: 'background.paper' }}>
                    {categories.map((value) => {
                        ...
                        return (
                            <ListItem
                                ...
                                secondaryAction={
                                    <Checkbox
                                        ...
                                        checked={addedFurnitures.findIndex(i => i.id === value.id) !== -1}
                            ...
                            >
                                <ListItemButton>
                                    <ListItemText id={labelId} disableTypography primary={<Typography variant="h5" style={{ color: "rgba(0,0,0,.9)", fontSize: "26px" }}>{value.categoryName}</Typography>} />
                                </ListItemButton>
                            </ListItem>
                        );
                    })}
            ...
            <div style={{ display: "flex", justifyContent: "center", marginTop: "50px" }}>
                <Button onClick={() =>
                    setState(false)} variant="outlined">
                    <h3>Create Set</h3>
                </Button>
            </div>
        </div>
