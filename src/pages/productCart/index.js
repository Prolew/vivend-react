...
import { BsCircle,BsCircleFill } from "react-icons/bs"
 ...
 const ProductCart = () => {
  return (
    <div>
       <Box className='product-cart' sx={{flexDirection:"row",padding:"20px",display:"flex" }}>
            ...
            <Box>
              ...
              <Box sx={{
                ...
                <Box sx={{
                  ...
                  <Box sx={{alignItems:"center",justifyContent:"space-between",display:"flex",height:"10px"}}>
